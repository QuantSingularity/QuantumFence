...
class Camera(Base):
    ...
    status            = Column(_enum(CameraStatus),
                               default=CameraStatus.INITIALIZING, nullable=False)
    is_active         = Column(Boolean, default=True, nullable=False)
...
class Alert(Base):
    ...
    severity          = Column(_enum(AlertSeverity), default=AlertSeverity.MEDIUM, nullable=False)
